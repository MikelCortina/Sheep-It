...
public class SheepAgent : MonoBehaviour
{
    ...
    // ?? Thresholds din�micos seg�n tag del target ??????????????????????????
    ...
    // ??????????????????????????????????????????????????????????????????????
    // IDLE WANDER (campeo con direcci�n personal + radio l�mite)
    // ??????????????????????????????????????????????????????????????????????
    void IdleWanderUpdate()
    {
        ...
        // PRIORIDAD 3 (m�nima): buscar celda de hierba
    ...
    // ??????????????????????????????????????????????????????????????????????
    // PASTURE GRAZING (m�nima prioridad)
    // ??????????????????????????????????????????????????????????????????????
    ...
    // ??????????????????????????????????????????????????????????????????????
    // FOOD: b�squeda, movimiento y comer (FoodSource original)
    // ??????????????????????????????????????????????????????????????????????
