...
public class CarCamera : MonoBehaviour
{
    ...
    public float distance = 10f;        // Distancia hacia atr�s (crea el �ngulo)
    public float tiltAngle = 65f;       // Inclinaci�n vertical (90 = cenital, ~55-70 = angulado)
    public float followSmooth = 8f;     // Suavidad de seguimiento

    [Header("Rotaci�n con el coche")]
    [Tooltip("True = la c�mara rota con el coche (GTA 1 style).\n" +
    ...
    void LateUpdate()
    {
        ...
        // Calcular offset de posici�n: hacia atr�s y arriba seg�n el yaw actual
